...
Recovers failed runs with checkpoint rollback and adaptive fallback strategies (backoff, alternate providers, degraded mode).
...
- Run focused automation workflows around **Failure Recovery Automation**
...
```bash
# Clone
git clone https://github.com/mogus-prog/failure-recovery-automation-skill.git
cd failure-recovery-automation-skill
